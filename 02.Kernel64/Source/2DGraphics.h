...
void InternalDrawText(const RECT* pstMemoryArea, COLOR* pstMEmoryAddress, int iX, int iY, COLOR stTextColor, COLOR stBackgroundColor, const char* pcString, int iLength);
