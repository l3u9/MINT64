...
//     for(i = 0; iCount; i++)
//     {
//         iCommandLength = kStrLen(gs_vstCommandTable[i].pcComand);

//         if((iCommandLength == iSpaceIndex) && (kMemCmp(gs_vstCommandTable[i].pcComand, pcCommandBuffer, iSpaceIndex) == 0))
//         {
...
//     for(i = 0; i< iCount; i++)
//     {
//         iLength = kStrLen(gs_vstCommandTable[i].pcComand);
...
//     for(i = 0; i < iCount; i++)
//     {
//         kPrintf("%s", gs_vstCommandTable[i].pcComand);
//         kGetCursor(&iCursorX, &iCursorY);
