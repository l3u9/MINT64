...
int Main(char* pcArgument)
{
    ...
    qwWindowID = CreateWindow(iX, iY, iWidht, iHeight, WINDOW_FLAGS_DEFAULT | WINDOW_FLAGS_RESIZABLE, "한글 뷰어(Hangul viewer)");
    ...
    while(1)
    {
        ...
        switch(stReceivedEvent.qwType)
        {
            ...
            case EVENT_WINDOW_RESIZE:
                ...
                iWidht = GetRectangleWidth(&(pstWindowEvent->stArea));
...
BOOL DrawTextBuffer(QWORD qwWindowID, TEXTINFO* pstInfo)
{
    ...
    DrawText(qwWindowID, (iWidth - iLength * FONT_ENGLISHWIDTH) / 2, WINDOW_TITLEBAR_HEIGHT + 2, 
        RGB(255, 255, 255), RGB(55, 215, 47), vcBuffer, iLength);
